    ...
    _createClass(TextTruncate, [{
      ...
      value: function getRenderText() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['containerClassName', 'line', 'text', 'textTruncateChild', 'truncateText', 'element', 'onCalculated', 'onTruncated']);
        ...
        var width = 0;
        var lastIsEng = false;
        var isPrevLineWithoutSpace = true;
        var lastPos = 0;
